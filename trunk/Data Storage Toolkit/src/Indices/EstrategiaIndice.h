...
{
public:
	virtual void crear(string nombreArch,unsigned int tamanioBloque,int tamanioSerializadoClave,ComparadorClave* comp)=0;
	virtual void abrir(string nombreArch,ComparadorClave* comp)=0;
