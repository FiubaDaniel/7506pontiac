...
public:
	 ...
	 */
	 void inicializarArchivo1(std::string path, int longitudBloque, bool tieneBuffer, TipoBuffer tipoBuffer, int cant_buffers, bool tieneIndice, TipoIndice tipo, int longitudBloqueIndice, bool comprime, int longitudContenedor) throw (ExcepcionMisDatos);
	 /*
	  ...
	  * Si el archivo ya existe y esta comprimido, se descomprime al inicializar.
	  */
	 void inicializarArchivo2(std::string path, bool tieneBuffer,  TipoBuffer tipoBuffer, int cant_buffers, bool tieneIndice, TipoIndice tipo, int longitudBloqueIndice, bool comprime, int longitudContenedor) throw (ExcepcionMisDatos);
	 /*
