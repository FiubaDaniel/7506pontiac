...
class HashingExt: public EstrategiaIndice
{
        private:
                ...
                int contador_cubos; // cantidad de cubos creados
                ...
                int *tamanios; //arreglo de los tamaños de los atributos de la clave
                ...
                */
                void serializar_clave(char *clave_mem, const Clave *clave);
                ...
                */
                ...
                bool buscar_clave(const Clave *clave, Referencia *referencia, unsigned recuperar);
        ...
        public:
                 ...
                 */
                void crear(std::string nombre_arch, unsigned int tam_cubo_bytes, Clave *claves, Referencia *referencias, unsigned cant_reg_ini);
